...
function ButtonExpandReservation() {
        ...
        >
          <div className="flex flex-col items-start justify-start">
            ...
            <p className="text-sm text-gray-500">
              Tu reserva en el Club Campestre contará con una instancia
              dedicada. <br />
              Te enviaremos un correo para que recibas los detalles de tu
              reserva.
            </p>
          </div>
...
export default ButtonExpandReservation;
